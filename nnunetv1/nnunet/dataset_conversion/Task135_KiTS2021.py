...
if __name__ == '__main__':
    ...
    kits_data_dir = "/data/dusy/nnUNet/nnUNet_raw_data_base/data/"
    ...
    for c in case_ids:
        if isfile(join(kits_data_dir, c, kits_segmentation_filename)):
            ...
            master_filename = 'master_' + c.split('_')[1] + '.nii.gz'
            shutil.copy(join(kits_data_dir, c, master_filename), join(imagestr, c + '_0000.nii.gz'))
