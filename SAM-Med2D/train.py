...
def train_one_epoch(args, model, optimizer,scaler, train_loader, epoch, criterion):
...
#        print(f"Batch {batch+1}, Iter point_coords: {batched_input['point_coords']}")
        batched_input = to_device(batched_input, args.device)
...
def main(args):
    ...
    for epoch in range(0, args.epochs):
        ...
        train_losses, train_iter_metrics = train_one_epoch(args, model,optimizer,scaler ,train_loader, epoch, criterion)
